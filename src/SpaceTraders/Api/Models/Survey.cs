...
#nullable enable
        public List<global::SpaceTraders.Api.Models.SurveyDeposit>? Deposits { get; set; }
#nullable restore
#else
        public List<global::SpaceTraders.Api.Models.SurveyDeposit> Deposits { get; set; }
#endif
...
#nullable restore
        ...
        public global::SpaceTraders.Api.Models.Survey_size? Size { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::SpaceTraders.Api.Models.Survey"/> and sets the default values.
        /// </summary>
        public Survey()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::SpaceTraders.Api.Models.Survey"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::SpaceTraders.Api.Models.Survey CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::SpaceTraders.Api.Models.Survey();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "deposits", n => { Deposits = n.GetCollectionOfObjectValues<global::SpaceTraders.Api.Models.SurveyDeposit>(global::SpaceTraders.Api.Models.SurveyDeposit.CreateFromDiscriminatorValue)?.AsList(); } },
                { "expiration", n => { Expiration = n.GetDateTimeOffsetValue(); } },
                { "signature", n => { Signature = n.GetStringValue(); } },
                { "size", n => { Size = n.GetEnumValue<global::SpaceTraders.Api.Models.Survey_size>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::SpaceTraders.Api.Models.SurveyDeposit>("deposits", Deposits);
            writer.WriteDateTimeOffsetValue("expiration", Expiration);
            writer.WriteStringValue("signature", Signature);
            writer.WriteEnumValue<global::SpaceTraders.Api.Models.Survey_size>("size", Size);

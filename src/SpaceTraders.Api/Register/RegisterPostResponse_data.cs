...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::SpaceTraders.Api.Models.Ship>? Ships { get; set; }
#nullable restore
#else
        public List<global::SpaceTraders.Api.Models.Ship> Ships { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "ships", n => { Ships = n.GetCollectionOfObjectValues<global::SpaceTraders.Api.Models.Ship>(global::SpaceTraders.Api.Models.Ship.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::SpaceTraders.Api.Models.Ship>("ships", Ships);

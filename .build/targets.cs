...
app.OnExecuteAsync(async _ =>
{
    ...
    const string solution = "AstroTrade.slnx";
    const string publishProject = null!; // = "src/AstroTrade/AstroTrade.csproj";
    const string packProject = null!; // = "src/AstroTrade.Lib/AstroTrade.Lib.csproj";
